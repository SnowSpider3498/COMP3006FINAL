...
class StormData:
    ...
    def _get_data(self):
        ...
        headers = []
        # self.data = []
        self.dictData = {} #should i have it as a dictionary? or a list? then i can utilize the class data similar to autompg.
    ...
    def graphStorm(self):
        ...
        for i in self.dictData.values():
            self.named.append(i[0])
            self.hurr.append(i[1])
            self.maj.append(i[2])
